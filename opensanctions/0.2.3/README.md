...
Version `0.2.3` enriches matched people with relatives and close associates when OpenSanctions exposes nested relationship data. RCA enrichment is always attempted for the first 20 person matches.
